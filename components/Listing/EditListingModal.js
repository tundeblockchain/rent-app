...
export default function EditListingModal({ updateProperty, currentEditListing, editListingModalOpen, setEditListingModalOpen, currentEditListingID }) {
    ...
    const onEdit = (e) => {
        e.preventDefault()
        updateProperty({
            propertyID: currentEditListingID,
            name,
            location,
            country,
            price,
                                ...
                                <div className="mt-2">
                                    <div className="grid grid-cols-1 gap-3">
                                        <label className="flex flex-col border rounded-lg px-3 py-2" htmlFor="location">
                                            ...
                                            <input placeholder={currentEditListing?.name} onChange={(e) => setName(e.target.value)} className="outline-none bg-transparent text-sm pt-1" type="text" id="name" name="name" />
                                        </label>
                                        ...
                                        <label className="flex flex-col border rounded-lg px-3 py-2" htmlFor="imageURL">
                                            ...
                                            <input placeholder={currentEditListing?.image} onChange={(e) => setImageURL(e.target.value)} className="outline-none bg-transparent text-sm pt-1" type="text" id="imageURL" name="imageURL" />
                                        </label>
                                    </div>
